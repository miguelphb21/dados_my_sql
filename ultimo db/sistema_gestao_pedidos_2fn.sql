...
CREATE TABLE `pedidos_2fn` (
  ...
  CONSTRAINT `pedidos_2fn_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `clientes_2fn` (`id`)
...
INSERT INTO `pedidos_2fn` VALUES (1,1,'2023-01-01',100.00),(2,2,'2023-01-02',200.00);
